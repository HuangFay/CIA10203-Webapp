...
//	@DateTimeFormat(pattern="yyyy-MM-dd") 
	...
	public void setReservationControlDate(Date reasrvationControlDate) {
		this.reservationControlDate = reasrvationControlDate;
	}
	public String getReservationControlTable() {
		return reservationControlTable;
	}
	public void setReservationControlTable(String reasrvationControlTable) {
		this.reservationControlTable = reasrvationControlTable;
	}
